const translations = {
  ...
  English: {
    ...
    socialsSub: "Follow Supreme Archive and join the community.",
    appSettingsSub: "Customize Supreme Archive features.",
    captchaAssist: "Captcha Assist",
    entireArchive: "Entire Archive in Build a Fit",
    close: "Close",
  ...
  French: {
    ...
    socialsSub: "Suivez Supreme Archive et rejoignez la communauté.",
    appSettingsSub: "Personnalisez les fonctionnalités de Supreme Archive.",
    captchaAssist: "Assistance Captcha",
    entireArchive: "Archive complète dans Créer un Fit",
    close: "Fermer",
  ...
  Spanish: {
    ...
    request: "Solicitar",
    appSettings: "Ajustes",
    socialsSub: "Sigue a Supreme Archive y únete a la comunidad.",
    appSettingsSub: "Personaliza las funciones de Supreme Archive.",
    captchaAssist: "Asistencia de Captcha",
    entireArchive: "Archivo completo en Crear outfit",
    close: "Cerrar",
  ...
  Japanese: {
    ...
    request: "リクエスト",
    appSettings: "設定",
    socialsSub: "Supreme Archiveをフォローしてコミュニティに参加しましょう。",
    appSettingsSub: "Supreme Archiveの機能をカスタマイズします。",
    captchaAssist: "Captchaアシスト",
    entireArchive: "コーデ作成ですべてのアーカイブを使用",
    close: "閉じる",
    settingsTitle: "設定を変更",
    ...
    tapToName: "タップして名前",
    nameThisFit: "Fitの名前:",
    loadInBuilder: "ビルダーで開く",

    requestItem: "アイテムをリクエスト",
    yourEmail: "メールアドレス（任意）",
    itemName: "アイテム名",
    season: "シーズン",
    submit: "送信",
  ...
  Korean: {
    ...
    request: "요청",
    appSettings: "설정",
    socialsSub: "Supreme Archive를 팔로우하고 커뮤니티에 참여하세요.",
    appSettingsSub: "Supreme Archive 기능을 사용자 지정하세요.",
    captchaAssist: "Captcha 도움",
    entireArchive: "핏 만들기에서 전체 아카이브 사용",
    close: "닫기",
    settingsTitle: "설정 변경",
    settingsSub: "언어와 통화를 선택하세요",
    language: "언어",
    currency: "통화",
    cancel: "취소",
    saveChanges: "저장",
  ...
  Chinese: {
    ...
    request: "请求",
    appSettings: "设置",
    socialsSub: "关注 Supreme Archive 并加入社区。",
    appSettingsSub: "自定义 Supreme Archive 功能。",
    captchaAssist: "Captcha 辅助",
    entireArchive: "搭配造型中使用完整档案",
    close: "关闭",
    settingsTitle: "更改设置",
    settingsSub: "选择语言和货币",
    language: "语言",
...
German: {
  add: "+ Hinzufügen",
  buildFit: "Fit erstellen",
  requestItems: "Items anfragen",
  languageCurrency: "Sprache & Währung",
  socials: "Soziales",
  request: "Anfragen",
  appSettings: "Einstellungen",
  socialsSub: "Folge Supreme Archive und werde Teil der Community.",
  appSettingsSub: "Passe die Funktionen von Supreme Archive an.",
  captchaAssist: "Captcha-Hilfe",
  entireArchive: "Gesamtes Archiv im Fit-Builder",
  close: "Schließen",
  settingsTitle: "Einstellungen ändern",
  settingsSub: "Wähle deine Sprache und bevorzugte Währung",
  language: "Sprache",
  currency: "Währung",
  cancel: "Abbrechen",
  saveChanges: "Speichern",
  totalPieces: "Gesamtteile",
  ...
  save: "Speichern",
  yourFits: "Deine Fits",
  tapToName: "Tippen zum Benennen",
  nameThisFit: "Diesen Fit benennen:",
  loadInBuilder: "Im Builder öffnen",

  requestItem: "Item anfragen",
  yourEmail: "Deine E-Mail (optional)",
  itemName: "Item-Name",
  season: "Saison",
  submit: "Senden",
  enterItemName: "Item-Name eingeben",
  enterSeason: "Saison eingeben",
  sending: "Wird gesendet...",
  requestSent: "Anfrage gesendet ✓",
  couldNotSend: "Konnte nicht senden",
...
Italian: {
  add: "+ Aggiungi",
  buildFit: "Crea fit",
  requestItems: "Richiedi articoli",
  languageCurrency: "Lingua e valuta",
  socials: "Social",
  request: "Richiedi",
  appSettings: "Impostazioni",
  socialsSub: "Segui Supreme Archive e unisciti alla community.",
  appSettingsSub: "Personalizza le funzioni di Supreme Archive.",
  captchaAssist: "Assistenza Captcha",
  entireArchive: "Archivio completo nel builder di fit",
  close: "Chiudi",
  settingsTitle: "Modifica impostazioni",
  settingsSub: "Scegli lingua e valuta preferita",
  language: "Lingua",
  currency: "Valuta",
  cancel: "Annulla",
  saveChanges: "Salva",
  ...
  fits: "Fits",
  save: "Salva",
  yourFits: "I tuoi Fits",
  tapToName: "Tocca per nominare",
  nameThisFit: "Nomina questo fit:",
  loadInBuilder: "Apri nel builder",

  requestItem: "Richiedi articolo",
  yourEmail: "La tua email (opzionale)",
  itemName: "Nome articolo",
  season: "Stagione",
  submit: "Invia",
  enterItemName: "Inserisci nome articolo",
  enterSeason: "Inserisci stagione",
  sending: "Invio...",
  requestSent: "Richiesta inviata ✓",
  couldNotSend: "Impossibile inviare",
...
Portuguese: {
  add: "+ Adicionar",
  buildFit: "Criar look",
  requestItems: "Solicitar itens",
  languageCurrency: "Idioma e moeda",
  socials: "Redes sociais",
  request: "Solicitar",
  appSettings: "Configurações",
  socialsSub: "Siga o Supreme Archive e participe da comunidade.",
  appSettingsSub: "Personalize os recursos do Supreme Archive.",
  captchaAssist: "Assistência de Captcha",
  entireArchive: "Arquivo completo no Criar look",
  close: "Fechar",
  settingsTitle: "Alterar configurações",
  settingsSub: "Escolha seu idioma e moeda preferida",
  language: "Idioma",
  currency: "Moeda",
  cancel: "Cancelar",
  saveChanges: "Salvar",
  ...
  save: "Salvar",
  yourFits: "Seus Looks",
  tapToName: "Toque para nomear",
  nameThisFit: "Nomear este look:",
  loadInBuilder: "Abrir no builder",

  requestItem: "Solicitar item",
  yourEmail: "Seu email (opcional)",
  itemName: "Nome do item",
  season: "Temporada",
  submit: "Enviar",
  enterItemName: "Digite o nome do item",
  enterSeason: "Digite a temporada",
  sending: "Enviando...",
